...
export function count_characters(a: number, b: number, c: number): void;
export function generate_password(a: number, b: number, c: number, d: number, e: number): void;
export function guessable(a: number, b: number, c: number): void;
export function calculate_entropy(a: number, b: number, c: number): void;
